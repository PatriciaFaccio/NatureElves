    ...
    def run(self, player_score: list[int]):
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if not found_player: #se o jogador não for encontrado.
                    return False

            #printed text
            self.level_text(14, f'{self.name} - Timeout: {self.timeout / 1000:.1f}s', C_WHITE, (10, 5)) #tempo duração fase
